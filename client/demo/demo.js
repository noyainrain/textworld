...
new p5((p) => {
  ...
  const model = new Circle(
    1, 1, body(1 / 2, 1 / 2), { stroke: null, fill: null },
    ...
    new Circle(
      ...
      // Face
      new Circle(
        1 / 2, 1 / 2, body(1 / 2, 1 / 2 / 2), { stroke: null, fill: null },
        // Eyes
        new Circle(
          1 / 4, 1 / 4, body(1 / 4, 1 / 2), { stroke: "pink", fill: "black" },
          new Circle(1 / 2, 1 / 2, body(1 / 2, 1 / 2), { fill: "pink" }),
        ),
        new Circle(
          1 / 4, 1 / 4, body(3 / 4, 1 / 2), { stroke: "pink", fill: "black" },
          new Circle(1 / 2, 1 / 2, body(1 / 2, 1 / 2), { fill: "pink" }),
        ),
        // Sleepy eyes
        new Circle(
          1 / 4, 1 / 4, body(1 / 4, 1 / 2), { stroke: "pink", end: 1 / 2 },
        ),
        new Circle(
          1 / 4, 1 / 4, body(3 / 4, 1 / 2), { stroke: "pink", end: 1 / 2 },
        ),
        // Mouth
        new Circle(
          1 / 8, 1 / 8, body(1 / 2, 5 / 6), {},
          new Circle(1, 1, body(0, 0), { stroke: "pink", fill: "black", end: 1 / 2 }),
          new Circle(1, 1, body(1, 0), { stroke: "pink", fill: "black", end: 1 / 2 }),
          // new Triangle(
      ...
      // Ears
      new Triangle(
        earW / 2, earH / 2, edge(0, 22 / 32, h(earH / 2 / 2 - earH / 2 / 8)), { start: 1, end: 3 },
      ),
      new Triangle(
        earW / 2, earH / 2, edge(0, 26 / 32, h(earH / 2 / 2 - earH / 2 / 8)), { start: 1, end: 3 },
      ),
      // Paws
      new Circle(1 / 8, 1 / 8, body(1 / 2 - 1 / 8 / 2, 1 - 1 / 8 / 4), { end: 1 / 2 }),
      new Circle(1 / 8, 1 / 8, body(1 / 2 + 1 / 8 / 2, 1 - 1 / 8 / 4), { end: 1 / 2 }),
    ),
  );
